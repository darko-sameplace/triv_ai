...
class Question extends amplify_core.Model {
  ...
  const Question._internal({required this.id, required title, required answer, required category, required difficulty, required options, createdAt, updatedAt, result, owner}): _title = title, _answer = answer, _category = category, _difficulty = difficulty, _options = options, _createdAt = createdAt, _updatedAt = updatedAt, _result = result, _owner = owner;
  
  factory Question({String? id, required String title, required String answer, required String category, required String difficulty, required List<String> options, amplify_core.TemporalDateTime? createdAt, amplify_core.TemporalDateTime? updatedAt, Result? result, String? owner}) {
  ...
  Question copyWith({String? title, String? answer, String? category, String? difficulty, List<String>? options, amplify_core.TemporalDateTime? createdAt, amplify_core.TemporalDateTime? updatedAt, Result? result, String? owner}) {
    return Question._internal(
      id: id,
  ...
  Question.fromJson(Map<String, dynamic> json)  
    : id = json['id'],
      ...
      _result = json['result']?['serializedData'] != null
        ? Result.fromJson(new Map<String, dynamic>.from(json['result']['serializedData']))
        : null,
      _owner = json['owner'];
  
  Map<String, dynamic> toJson() => {
    'id': id, 'title': _title, 'answer': _answer, 'category': _category, 'difficulty': _difficulty, 'options': _options, 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format(), 'result': _result?.toJson(), 'owner': _owner
  };
